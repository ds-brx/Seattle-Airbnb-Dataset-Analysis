...
Summary of Analysis : 
Average prices of Condominium property types are the highest and they gradually decrease from Houses and Lofts to Apartments and other types. Pricing is mainly influenced by number of bedrooms,bathrooms and number of amenities. Random Forest Regresson is used to predict prices of unknown property types based on the important features concluded from the correlations heatmap.
